        ...
        useEffect(() => {
            const fetchOrders = async () => {
                try {
                    ...
                    // Filter orders with paymentMethod: 'wallet'
                    const walletOrders = response.data.filter(order => order.paymentMethod === 'wallet');
                    console.log('Filtered wallet Orders:', walletOrders);
